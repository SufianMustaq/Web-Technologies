...
if($user->validation()==0)
{
     ...
     $user->json();
     getdata($Name ,$userName,$email, $phone,$pass,$gender);
     session_start();
     $_SESSION["SuserName"]="$userName";
     /*header("Location:http://localhost/c2/Project/view/users/login.php");*/

     echo "<a href='https://localhost/c3/Project/view/users/login.php'> Go LogIn page page !!</a>";
}
else{
   ...
   die();
   echo "<a href='https://localhost/c3/Project/view/users/registration.php'> Go back to registration page !!</a>";
}
?>